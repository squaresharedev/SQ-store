...
// 2026-09-24): a utf-8 data: URL whose SVG, rendered by SVGo, opens with an
// XML declaration AND a comment. A bare <svg> here once hid a parser that
// refused every real QR code.
